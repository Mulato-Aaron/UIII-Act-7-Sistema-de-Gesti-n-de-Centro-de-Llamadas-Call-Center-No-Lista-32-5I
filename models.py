...
class Llamada(models.Model):
    id_agente = models.ForeignKey(AgenteCallCenter, on_delete=models.CASCADE)
    id_cliente = models.ForeignKey(ClienteCallCenter, on_delete=models.CASCADE)
...
class ProblemaReportado(models.Model):
    ...
    id_agente_resolvio = models.ForeignKey(
        AgenteCallCenter, on_delete=models.SET_NULL, null=True
    )
